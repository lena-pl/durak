...
RSpec.describe ApplyDefendAction do
  ...
  describe "#call" do
    context "when the card is not in player one's hand" do
      let(:defend_action) { Action.new(:kind => :defend, :active_card => card, :passive_card => passive_card, :initiating_player => player_one) }
    ...
    context "when the card is not in player two's hand" do
      let(:defend_action) { Action.new(:kind => :defend, :active_card => card, :passive_card => passive_card, :initiating_player => player_two) }
